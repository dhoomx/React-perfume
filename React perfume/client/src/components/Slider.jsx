...
const Arrow = styled.div`
  ...
  align-items: center;
  /* its parent must by "position: relative" */
  position: absolute;
  /* /// */
  top: 0;
  bottom: 0;
      ...
      <Wrapper slideIndex={slideIndex}>
        {sliderItems.map((item) => (
          <Slide bg={item.bg} key={item.id}>
            <ImgContainer>
              {/* <Image src="https://cdn.salla.sa/bZEQj/t8K4jaYEoCf2nWDENnPlk8kXVAsgA1mxYRU8t6e3.jpg" /> */}
              <Image src={item.img} />
            </ImgContainer>
            <InfoContainer>
              {/* <Title>GUCCI</Title> */}
              <Title>{item.title}</Title>
              {/* <Descreption>Perfium for you lady </Descreption> */}
